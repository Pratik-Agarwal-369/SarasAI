...
# Read secret API key from Streamlit config
openai.api_key = st.secrets["openai_key"]

st.set_page_config(page_title="SarasAI", layout="centered", initial_sidebar_state="collapsed")
st.markdown("<h1 style='text-align: center; color: white;'>🌸 SarasAI 🌸SarasAI</h1>", unsafe_allow_html=True)
...
st.markdown("<footer style='text-align: center; color: gray; font-size: 12px;'>Made by Pratik Agarwal</footer>", unsafe_allow_html=True)
